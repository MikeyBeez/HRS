\section{Test-Time Memory Without Forgetting: An Adapter Library Indexed by Mean-Pooled Activations}\label{test-time-memory-without-forgetting-an-adapter-library-indexed-by-mean-pooled-activations}
...
\subsection{3. The Routing Space}\label{the-routing-space}

\subsubsection{3.1 Centroid theory of context}\label{centroid-theory-of-context}
...
\subsubsection{3.2 K-space and V-space alignment}\label{k-space-and-v-space-alignment}
...
\subsubsection{3.3 The L0/L5 duality}\label{the-l0l5-duality}
...
\subsubsection{3.4 The phase transition in resolvability}\label{the-phase-transition-in-resolvability}
...
\subsubsection{3.5 Random vector ablation}\label{random-vector-ablation}
...
\subsubsection{3.6 Cross-architecture validation}\label{cross-architecture-validation}
...
\subsection{4. Application 1: Per-Passage Adapter Library}\label{application-1-per-passage-adapter-library}
...
\subsubsection{4.2 Routing}\label{routing}
...
\subsubsection{4.3 Saliency-weighted absorption}\label{saliency-weighted-absorption}
...
\subsubsection{4.4 Storage and deployment}\label{storage-and-deployment}
...
\subsubsection{4.5 Adapter clustering is impossible}\label{adapter-clustering-is-impossible}
...
\subsection{5. Application 2: MPAR-Compressed KV Cache}\label{application-2-mpar-compressed-kv-cache}

\subsubsection{5.1 Compression curve}\label{compression-curve}
...
\subsubsection{5.2 Learned MPAR encoders}\label{learned-mpar-encoders}
...
\subsubsection{5.3 The V-space tradeoff}\label{the-v-space-tradeoff}
...
\subsection{6. Application 3: Compositional Retrieval}\label{application-3-compositional-retrieval}

\subsubsection{6.1 Weight merging fails}\label{weight-merging-fails}
...
\subsubsection{6.2 Activation-level block-stacking}\label{activation-level-block-stacking}
...
\subsubsection{6.3 Compositional decay: a gradient, not a ceiling}\label{compositional-decay-a-gradient-not-a-ceiling}
...
\subsubsection{Stable geometric routing spaces}\label{stable-geometric-routing-spaces}
...
\subsubsection{V-space lossiness as a design principle}\label{v-space-lossiness-as-a-design-principle}
...
\subsubsection{Compositional decay factors into V-space load and decoding complexity}\label{compositional-decay-factors-into-v-space-load-and-decoding-complexity}
...
\subsection{Appendix A: Complete Phase Listing}\label{appendix-a-complete-phase-listing}
...
\subsection{Appendix B: V-space Interventions}\label{appendix-b-v-space-interventions}
...
\subsection{Appendix C: K=3 Content-Type Ablation (Phase 67)}\label{appendix-c-k3-content-type-ablation-phase-67}
...
\subsection{NeurIPS Paper Checklist}\label{neurips-paper-checklist}

\textbf{1. Claims.} Yes --- the abstract and introduction accurately reflect the paper's contributions and scope.

\textbf{2. Limitations.} Yes --- limitations are discussed in a dedicated section (§8).
