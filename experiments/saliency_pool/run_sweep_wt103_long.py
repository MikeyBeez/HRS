"""Follow-up experiment 1: extended training (20K steps) for variants
B and baseline at WT-103 scale, 4 seeds each.

Tests whether B's lead at 5K steps persists with more training, or
whether Bonsignore catches up.

Output: `results_wt103_long/`.
"""
...
SWEEP_VARIANTS = ["baseline", "B", "sdpa"]
...
def main():
    ...
    ap.add_argument("--out", default="experiments/saliency_pool/results_wt103_long")
    ...
    for i, (v, s) in enumerate(todo):
        ...
        # Eval every 500 steps (per spec) to capture trajectory shape.
        tcfg.eval_every = 500
