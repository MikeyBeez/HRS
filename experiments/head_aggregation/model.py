"""TinyBonsignoreTransformer for head-aggregation ablation on Shakespeare."""
...
from experiments.head_aggregation.attention import BonsignoreAttention
...
class Block(nn.Module):
    def __init__(self, cfg: ModelConfig):
        ...
        self.attn = BonsignoreAttention(cfg)
...
class TinyBonsignoreTransformer(nn.Module):
    def __init__(self, cfg: ModelConfig):
        super().__init__()
